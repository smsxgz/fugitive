"""Full-game payoff sampling, validation, and holdout evaluation for PSRO."""
...
from .model import Role, Winner
from .payoff_ledger import PayoffLedger, PayoffSample, deterministic_sample_id
from .psro import (
    PayoffEstimate,
    PayoffEvaluation,
    PayoffPair,
...
from .psro_policy_adapter import agent_spec_from_policy
...
def _run_registered_payoff_game(
    ...
    if run.status is not ExperimentStatus.COMPLETED or run.game_result is None:
