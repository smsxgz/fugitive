...
from fugitive.agents.marshal.inference.observation_validation import ObservationContractError
from fugitive.agents.marshal.inference.particle_belief import (
    DEFAULT_PARTICLE_COUNT,
    MarshalParticle,
    MarshalParticleBelief,
)
from fugitive.agents.marshal.inference.particles.bootstrap_filter import (
    _advance_play,
...
def test_particle_count_must_be_a_positive_integer() -> None:
...
@pytest.mark.parametrize("particle_count", (True, 0, 1.5))
...
@pytest.mark.parametrize("proposal_count", (True, 0, 1.5))
