...
from fugitive.agents.marshal.inference.constructive.constraints import CompiledMarshalConstraints
...
from fugitive.agents.marshal.inference.constructive.sampling import SamplingBudget
...
from fugitive.agents.marshal.inference.rejuvenation import (
...
def test_independent_mh_ratio_and_seeded_acceptance_match_hand_calculation() -> None:
    ...
    from fugitive.agents.marshal.inference.rejuvenation import _accept_log_probability
